...
let translate_rotate_scale_matrix = multiply_matrices(multiply_matrices(make_translate(2, 2), make_rotate(25, 25), 3, 3, 3, 3), make_scale(2, 2), 3, 3, 3, 3);

let scale_translate_rotate_matrix = multiply_matrices(multiply_matrices(make_scale(2, 4), make_translate(4, 4), 3, 3, 3, 3), make_rotate(-10, -10), 3, 3, 3, 3);
